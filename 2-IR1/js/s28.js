function validate(event) {
  ...
  function solution(event) {
    ...
    var paragraph = "<p>";
    paragraph += "Vergleichen deine Antwort!<br/>Auswirkungen von Synonymie und Polysemie auf das Retrieval Der Begriff Synonymie bezeichnet die inhaltliche Übereinstimmung von verschiedenen Wörtern oder Konstruktionen in derselben Sprache. Im IR kann Synonymie zur Folge haben, daß relevante Dokumente ignoriert werden, also eine Verschlechterung des Recall. Der Begriff Polysemie bezeichnet das Vorhandensein von mehreren Bedeutungen zu einem Wort. Im IR kann das zur Folge haben, dass irrelevante Dokumente in Betracht gezogen werden, also eine Verschlechterung der Precision.";
    paragraph += "</p>";
